...
project = 'pytopomat'
copyright = '2020, Nathan C. Frey, Jason Munro'
...
htmlhelp_basename = 'pytopomatdoc'
...
latex_documents = [
    (master_doc, 'pytopomat.tex', 'pytopomat Documentation',
     'Nathan C. Frey, Jason Munro', 'manual'),
]
...
man_pages = [
    (master_doc, 'pytopomat', 'pytopomat Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pytopomat', 'pytopomat Documentation',
     author, 'pytopomat', 'One line description of project.',
     'Miscellaneous'),
]
